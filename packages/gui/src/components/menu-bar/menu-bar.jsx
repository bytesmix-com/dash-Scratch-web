...
class MenuBar extends React.Component {
  ...
  render() {
    ...
    window.onStartSelectingFileUpload = this.props.onStartSelectingFileUpload;
    return (
      <Box>
        {/* <SB3Downloader>
          {(className, downloadProjectCallback) => {
            window.downloadProjectCallback = downloadProjectCallback;
            return null;
          }}
        </SB3Downloader> */}
        {/* <button onClick={() => this.props.onClickSave()}>저장하기</button> */}
